...
<head>
    ...
    <title>Undangan Pernikahan - Pipit & Angga</title>
        ...
        <div class="wrapper">
            <div class="separator">
                ...
                <div class="main-title">
                    <div class="top-title">
                        <span class="the-wedding-title signature-font aniTitle" style="text-align: center; line-height: 100px">
                            Undangan Pernikahan
                        </span>
                        {{-- <span class="title-head aniTitle"> Fitri </span> --}}
                        {{-- <span class="title-head aniTitle"> Angga </span> --}}
                    </div>
                    <div class="bottom-title">
                        {{--
                        <span class="the-wedding-title signature-font aniTitle">
                            Undangan Pernikahan
                        </span>
                        --}}
                        <button class="buka-udangan aniTitle" style="opacity: 0">
                            BUKA UNDANGAN
                        </button>
                        <span class="title-head aniTitle">
                            02 JULI 2023
                ...
                <a href="#" target="_self" class="music-control add-shadow off">
                    <img src="img/icon-sound.svg" class="sound-on" alt="" />
                    <img src="img/icon-sound-off.svg" class="sound-off" alt="" />
                </a>
                <audio id="background_music" loop="loop" src="music/wamuna.mp3"></audio>
                <div id="pay" class="float">
                    <a id="pay-button" href="#" target="_self" class="pay-btn add-shadow">
                        <img src="img/icon-uang.svg" alt="" />
                    </a>
                </div>
                        ...
                        <ul class="padding-bar">
                            <li>
                                <a id="click-date" class="bar-icon icon-date">
                                    <img src="img/icon-date.svg" class="img-off" alt="" />
                                    <img src="img/icon-date-active.svg" class="img-active" alt="" />
                                </a>
                            </li>
                            <li>
                                <a id="click-love" class="bar-icon icon-love">
                                    <img src="img/icon-love.svg" class="img-off" alt="" />
                                    <img src="img/icon-love-active.svg" class="img-active" alt="" />
                                </a>
                            </li>
                            <li>
                                <a id="click-maps" class="bar-icon icon-location">
                                    <img src="img/icon-location.svg" class="img-off" alt="" />
                                    <img src="img/icon-location-active.svg" class="img-active" alt="" />
                                </a>
                            </li>
                            <li>
                                <a id="click-instagram" class="bar-icon icon-insta">
                                    <img src="img/icon-insta.svg" class="img-off" alt="" />
                                    <img src="img/icon-insta-active.svg" class="img-active" alt="" />
                                </a>
                            </li>
                            <li>
                                <a id="click-doa" href="#doa-id" class="bar-icon icon-doa">
                                    <img src="img/icon-doa.svg" class="img-off" alt="" />
                                    <img src="img/icon-doa-active.svg" class="img-active" alt="" />
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="mobile-separator" id="mobile-scroll">
                <div class="welcome">
                    <img src="img/mobile-img.jpg" style="width: 100%" />
                    <div class="content">
                        <img src="img/content-top.svg" class="background-top" alt="" />
                        <div class="content-data">
                            <img src="img/scrolls.svg" class="scroll-up-down" alt="" />
                            <span class="title-content gs_reveal" style="font-size: 15px">
                                OFFICIALLY MENGUNDANG
                            </span>
                            <span class="title-content signature-font mobile-title gs_reveal gs_reveal_fromLeft">
                                Anda dan Partner
                            </span>
                            ...
                            <a href="https://calendar.google.com/calendar/u/0/r/eventedit/MDc3amVqdnZkNTQya2RqbzNscG92NDk4MnMgYWE2ZjcxYzk4OTc1ZWU0MDYzZGY0OGVjMWJkYzdlNWUzYTYyMjVlYTYyOWIzZTM4M2VkM2IwNzBjMzMwMDJlYUBn" target="_blank" class="save-date gs_reveal gs_reveal_fromLeft">
                                SAVE THE DATE
                            </a>
                            ...
                            <div class="daun-melayang">
                                <img src="img/daun.svg" class="img-kanan" alt="" />
                            </div>
                            <div class="daun-melayang">
                                <img src="img/daun.svg" class="img-kiri" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="end-content">
                        <img src="img/content-top.svg" style="width: 100%" alt="" />
                    </div>
                    <div class="doa">
                        <img src="img/pembukaan.svg" class="gs_reveal gs_reveal_fromRight" alt="" />
                        ...
                        <img src="img/pembukaan.svg" class="gs_reveal gs_reveal_fromLeft" style="transform: rotate(180deg)" alt="" />
                    </div>
                    <div class="content" style="margin-top: -120px">
                        <img src="img/content-top.svg" class="background-bot" alt="" />
                        <div class="content-data">
                            <div class="block-detail" id="date-id">
                                ...
                                <div class="wedding-bottom">
                                    <span class="kediaman gs_reveal"> MASJID NURHIDAYAH </span>
                                    <span class="kediaman font-dasar gs_reveal">
                                        Jln Demang Lebar Daun Kec. Ilir Barat 1 , Kota Palembang,
                            ...
                            <div class="space-daun gs_reveal">
                                <img src="img/daun-banyak.svg" class="w-100" alt="" />
                            </div>
                            <div id="love-id" class="block-profile">
                                <div class="profile-nickname mt-3 gs_reveal">
                                    <span class="panggilan signature-font">Fitri</span>
                                </div>
                                <div class="profile-picture gs_reveal gs_reveal_fromRight">
                                    <img src="img/profile-cewe.png" class="picture-rounded" style="border: 2px solid #ffffff; border-radius: 100%" alt="" />
                                </div>
                                <div class="profile-name mt-1 gs_reveal">
                                    <span class="title-content nama-lengkap">FITRI, S.Sos.</span>
                                </div>
                                {{--
                                <a href="https://www.instagram.com/beyshalayla/" target="_blank" class="profile-ig mt-1 btn-ig gs_reveal">
                                    ...
                                    <span style="margin-left: 10px">beyshalayla</span>
                                </a>
                                --}}
                                <div class="detail-keluarga gs_reveal">
                                    <p class="font-dasar">PUTRI KEDUA DARI</p>
                                    <p class="font-dasar">BAPAK DRS. DJUNAIDI ZAINI</p>
                                    <p class="font-dasar">&</p>
                                    <p class="font-dasar">IBU SUSILAWATI</p>
                                </div>
                                <div class="daun-melayang gs_reveal gs_reveal_fromRight">
                                    <img src="img/daun-profile-kanan.svg" class="img-kanan-profile" alt="" />
                                </div>
                                <div class="daun-melayang gs_reveal gs_reveal_fromLeft">
                                    <img src="img/daun-profile-kiri.svg" class="img-kiri-profile" alt="" />
                                </div>
                            </div>
                            <div class="block-dan mt-3">
                                <img src="img/dan.svg" alt="" />
                            </div>
                            <div class="block-profile">
                                <div class="profile-nickname mt-3 gs_reveal">
                                    <span class="panggilan signature-font">Angga</span>
                                </div>
                                <div class="profile-picture gs_reveal gs_reveal_fromLeft">
                                    <img src="img/profile-cowo.png" class="picture-rounded" style="border: 2px solid #ffffff; border-radius: 100%" alt="" />
                                </div>
                                <div class="profile-name mt-1 gs_reveal">
                                    <span class="title-content nama-lengkap">ANGGA FIRMANSYAH</span>
                                </div>
                                {{--
                                <a href="https://www.instagram.com/fiqihwew/" target="_blank" class="profile-ig mt-1 btn-ig gs_reveal">
                                    <img src="img/icon-ig.svg" alt="" />
                                    <span style="margin-left: 10px">fiqihwew</span>
                                </a>
                                --}}
                                <div class="detail-keluarga gs_reveal">
                                    <p class="font-dasar">PUTRA KEDUA DARI</p>
                                    <p class="font-dasar">BAPAK FAISAL MURODI</p>
                                    <p class="font-dasar">&</p>
                                    <p class="font-dasar">IBU DIANA ARTATI</p>
                                </div>
                                <div class="daun-melayang gs_reveal gs_reveal_fromRight">
                                    <img src="img/daun-profile-kb.svg" class="img-kb-profile" alt="" />
                                </div>
                            </div>
                            <div class="space-daun gs_reveal">
                                <img src="img/daun-banyak.svg" class="w-100" alt="" />
                            ...
                            <div class="block-profile">
                                <div class="profile-name mt-1 gs_reveal">
                                    <span class="title-content nama-lengkap">MARHABAH DAN AQIQAH</span>
                                </div>
                                <div class="profile-nickname mt-3 gs_reveal">
                                    <span class="panggilan signature-font">Fino</span>
                                </div>
                                <div class="profile-picture gs_reveal gs_reveal_fromLeft">
                                    <img src="img/bayi.png" class="picture-rounded" style="border: 2px solid #ffffff; border-radius: 100%" alt="" />
                                </div>
                                <div class="profile-name mt-1 gs_reveal">
                                    <span class="title-content nama-lengkap">ALFINO ZAYN ACHMAD</span>
                                </div>
                                {{--
                                <a href="https://www.instagram.com/fiqihwew" target="_blank" class="profile-ig mt-1 btn-ig gs_reveal">
                                    <img src="img/icon-ig.svg" alt="" />
                                ...
                                <div class="detail-keluarga gs_reveal">
                                    ...
                                    <p class="font-dasar">BAPAK ADAM SAHILI S.Pd</p>
                                    <p class="font-dasar">&</p>
                                    <p class="font-dasar">IBU ANIMINASUKA S.Pd</p>
                                </div>
                                <div class="daun-melayang gs_reveal gs_reveal_fromRight">
                                    <img src="img/daun-profile-kb.svg" class="img-kb-profile" alt="" />
                                </div>
                    ...
                    <div class="end-content">
                        <img src="img/content-top.svg" class="top-location" alt="" />
                    </div>
                    {{--
                    ...
                    <div class="google-maps gs_reveal gs_reveal_fromRight" id="maps-id">
                        <div class="cover-maps">
                            <div class="mapouter">
                                <div class="gmap_canvas">
                                    <iframe width="376" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=masjid%20nurhidayah%20palembang&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                                    <br />
                                    <style>
                                        .mapouter {
                                            position: relative;
                        ...
                        <span class="font-dasar font-black mt-2 gs_reveal" style="font-weight: 600">
                            Jl. Demang Lebar Daun, Demang Lebar Daun, Kec. Ilir Bar. I, Kota
                            Palembang, Sumatera Selatan 30137
                        </span>
                        <a href="https://goo.gl/maps/6SUxY1KZw3ZHRoKR7" target="_blank" class="btn-white gs_reveal" style="text-align: center">
                            SEE LOCATION
                        </a>
                    </div>
                    <div class="content pembates-margin">
                        <img src="img/content-top.svg" style="width: 100%" alt="" />
                        <div class="content-data">
                            <span class="akad-nikah signature-font gs_reveal gs_reveal_fromRight" style="padding-top: 3rem">
                                Live Streaming
                            </span>
                            <span class="title-content find-ig gs_reveal">
                                FIND OUR WEDDING VIRTUALLY ON INSTAGRAM
                            </span>
                            <a href="https://www.instagram.com/fitridjunaidizaini/" target="_blank" class="btn-white gs_reveal" id="instagram-id" style="text-align: center">
                                <img src="img/bx_video.svg" alt="" />
                            ...
                            <div class="w-100">
                                <div class="form-wrap mt-2 gs_reveal">
                                    ...
                                    <div class="input-form">
                                        <input type="text" class="w-100 input-t" id="nama" name="nama" placeholder="Nama Anda" value="Anda dan Partner" required />
                                    </div>
                                </div>
                                <div class="form-wrap mt-2 gs_reveal">
                                    <div class="label">LOKASI</div>
                                    <div class="input-form">
                                        <input type="text" class="w-100 input-t" id="lokasi" name="lokasi" placeholder="Asal Daerah" required />
                                    </div>
                                </div>
                                <div class="form-wrap mt-2 gs_reveal">
                                ...
                                <button type="button" id="submit" name="submit" value="Submit" class="btn-send gs_reveal">
                    ...
                    --}}
                    <div class="last-img w-100 gs_reveal">
                        <img src="img/img-end.svg" class="w-100" alt="" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w3-container">
                ...
                <div class="choosen-bank">
                    ...
                    <div class="bank-detail">
                        <span class="title aniModal"> BCA </span>
                        <span class="bank-title aniModal">
                            3410637811 <img src="img/copy.png" alt="" />
                        </span>
                        <span class="bank-name aniModal"> a/n Fitri </span>
                    </div>
                </div>
                {{--
                <div class="choosen-bank">
                    ...
                    <div class="bank-detail">
                        <span class="title aniModal"> BCA </span>
                        <span class="bank-title aniModal">
                            1671270172 <img src="img/copy.png" alt="" />
                        </span>
                        <span class="bank-name aniModal"> a/n Angga Firmansyah </span>
                    </div>
                </div>
                <div class="choosen-bank">
                    <div class="bank-img aniModal">
                    ...
                    <div class="bank-detail aniModal">
                        ...
                        <span class="bank-name"> a/n Ahmad Fiqih </span>
                    </div>
                </div>
                <div class="choosen-bank">
                    <div class="bank-img aniModal">
        ...
        <div class="w3-modal-content text-modal-center">
            ...
            <div class="w3-container">
                ...
                <div class="img-save aniModal">
                    <img src="img/distance.png" style="width: 80%" alt="" />
                </div>

                <button id="okay" class="btn-send aniModal" style="margin-bottom: 1rem">
                    Okay, I Understand
                </button>
            </div>
        </div>
